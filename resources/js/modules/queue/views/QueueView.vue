    ...
    <div class="space-y-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Cola de Reintentos de Transmisión (Background Jobs)</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Monitoreo y gestión de trabajos de envío diferido a los servidores del Ministerio de Hacienda
                </p>
            </div>
            <BaseButton variant="outline" size="auto" @click="refreshQueue">Actualizar Cola</BaseButton>
        </div>
        ...
        <p class="text-right text-xs text-gray-400 dark:text-gray-500">Última actualización: {{ lastUpdated.toLocaleString('es-SV') }}</p>
    </div>
</template>
